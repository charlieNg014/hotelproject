...
export default  class Contact extends Component {
    ...
    state = {
        ...
        {title:"Stay Connected", subtitle:"Monash University", details1: "14/201 Auburn Road, Hawthorn VIC 3122", details2: "0450 766 930", details3: "mngu0070@student.monash.edu"},
            ...
            {title:"References", subtitle: "CAN I HAVE YOUR NAME AS REFERENCE HERE?", details1: "Nawfal Ali, PhD Teaching Associate. Faculty of Information Technology, Monash University", details2: "", details3: ""}
        ]
    }
    render(){
        return(
